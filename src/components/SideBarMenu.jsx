  ...
  return (
    <div className='w-[20%]  bgcolor'>
      <div className='flex flex-col gap-2 px-5 '>
        ...
        <div className="bgcolor  w-full h-[3.5rem] items-center flex  text-2xl" ref={classRef} onClick={classRef.current && classRef.current.classList.contains("active") ? (en)=>en.target.classList.remove("active") : (en)=>en.target.classList.add("active")}>
        ...
        <div className="bgcolor w-full h-[3.5rem] items-center flex text-2xl" ref={classRef} onClick={classRef.current && classRef.currentclassList.contains("active") ? (en)=>en.target.classList.remove("active") : (en)=>en.target.classList.add("active")}>
        ...
        <div className="bgcolor w-full h-[3.5rem] mt-9 flex text-3xl gap-3 items-center"><i class="ri-menu-line"></i><h1 class="text-xl font-light">Menu</h1></div>        
      </div>
    </div>
  )
}
